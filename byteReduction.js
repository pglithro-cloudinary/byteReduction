javascript: (() => {
    ...
    getJSON(baseUrl + 'fl_getinfo/' + img,
        function(err, data) {
            if (err !== null) {
                ...
                format = data.output.format,
                    ...
                    opts = 'w_800/l_text:Open%20sans_320_center:%E2%96%BC,co_green,w_300,ar_1,c_lpad,b_rgb:0C163B,r_max/fl_layer_apply,g_north_east,x_30,y_30,e_outline:outer,co_rgb:3F5FFF,o_93/l_logo,w_60/w_370,h_39,c_lpad/fl_layer_apply,g_north_east,y_54/l_text:Open%20sans_84_center_bold:' + percentChange.toFixed(1) + '%2525,w_370,h_96,c_lpad,co_white/fl_layer_apply,g_north_east,y_120/l_text:Open%20sans_35_center_bold:REDUCTION,w_370,c_lpad,co_white/fl_layer_apply,g_north_east,y_206/l_text:Open%20sans_35_center:(' + diffKB + ' kB),w_370,c_lpad,co_white/fl_layer_apply,g_north_east,y_238/',
                    newUrl = baseUrl + opts + img;
                l.assign(newUrl);
            }
        });
